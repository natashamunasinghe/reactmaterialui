    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={8} md={8}>
          ...
          <p>
            First thoughts as we landed. Oh! It was the Easter break - 'the
            people' were on holiday. And yes it was ridiculously clean (but also
            expensive). The whole reason I love the 3rd world is because I earn
            in dollars for godsake!
            <br />
            <br />
          </p>
          <Quote
